...
const DepartmentManagementPage: React.FC = () => {
  ...
  const isParentDepartmentOptionAvailable = parentDepartments.some(
    (parentDepartmentItem) => parentDepartmentItem.id === department?.parentDepartmentId
  );
  const parentDepartmentItems =
    department?.parentDepartmentId && !isParentDepartmentOptionAvailable
      ...
      : parentDepartments;
  const isManagerOptionAvailable = managers.some((managerItem) => managerItem.id === department?.managerId);
  const managerItems =
