...
import { Employee, EntityInput, ErrorResponse } from 'shared/types';
...
import { getProblemStatus, mapEmployee, mapEmployeeRetrievalModel, mapError, createProblemDetails } from 'shared/helpers';
  ...
  async (_, { getState, rejectWithValue }) => {
    ...
    return foldClientResult(
      ...
      (data) => {
        ...
        return mapEmployee({ user, employee: mapEmployeeRetrievalModel(data) });
      },
