...
import { CompanySettings, EntityInput, ErrorResponse } from 'shared/types';
...
import {
  ...
  mapCompanySettingsRetrievalModel,
} from 'shared/helpers';
...
export const fetchCompanySettings = createAsyncThunk<CompanySettings, void, { rejectValue: ProblemDetailsModel }>(
  ...
  async (_, { rejectWithValue }) => {
    ...
    return foldClientResult(
      result,
      (data) => {
        const companySettings = mapCompanySettingsRetrievalModel(data);
