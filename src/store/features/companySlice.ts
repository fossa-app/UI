...
const companySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchCompany.rejected, (state, action: PayloadAction<ValidationProblemDetails | undefined>) => {
      ...
      .addCase(deleteCompany.rejected, (state, action: PayloadAction<ValidationProblemDetails | undefined>) => {
